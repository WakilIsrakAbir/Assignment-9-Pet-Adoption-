      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-400 max-w-2xl mx-auto">
            Browse our list of lovable pets waiting for a forever home. Use the
              ...
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  {pet.status === "adopted" && (
                    <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                      <span className="bg-red-500 text-white px-4 py-2 rounded-md font-bold transform -rotate-12 border-2 border-white">
                        ADOPTED
                      </span>
                    </div>
                  )}
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <div className="text-sm text-gray-500 dark:text-slate-400 mb-4 flex-grow space-y-1 mt-2">
                    ...
                    <p className="flex items-center gap-2">
                      <span>📅</span> {pet.age}{" "}
                      {pet.age === 1 ? "year" : "years"} old ({pet.gender})
                    </p>
                    <p className="flex items-center gap-2">
